package com.transcendss.mavric.events.ddot
{
	...
	public class DdotSyncEvent extends Event
	{
		...
		public static const LINK_ID_REQUEST:String ="getLivelinkIDs_event";
		public static const LINK_OBJECTID_REQUEST:String ="getLiveLinkIDs_objectID_event";
		public static const TR_OBJECTID_REQUEST:String ="timeRestrictionIDs_objectID_event";
