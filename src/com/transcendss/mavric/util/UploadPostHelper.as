package com.transcendss.mavric.util
{
		...
		public class UploadPostHelper {
			 ...
			 */
			public static function getPostData(fileName:String, byteArray:ByteArray ,fileType:String, parameters:Object = null):ByteArray {
				...
				postData = BOUNDARY(postData);
				postData = LINEBREAK(postData);
				bytes = 'Content-Disposition: form-data; name="attachment"; filename='+fileName ;
